...
<h1 class="max-w-screen-xl  flex-wrap justify-between mx-auto p-4 mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-600">Digital </span>Wallet</h1>
