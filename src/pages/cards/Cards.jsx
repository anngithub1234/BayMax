        ...
        <div class="flex flex-col justify-center items-center h-full">
            <div class="relative flex flex-col items-center rounded-[20px] w-full mx-auto p-4 bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:!shadow-none">
                <div class="relative flex h-32 w-full justify-center rounded-xl bg-cover" >
                    <img src='https://source.unsplash.com/Y0hLfXje8bQ' class="absolute flex h-32 w-full justify-center rounded-xl bg-cover"/> 
                ...
                <div class="mt-1 flex flex-col items-center">
                    <p class="text-base font-normal text-gray-600">Your points</p>
                </div>
